                            ...
                            <div className="col-sm-6">
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <hr/>
                                        <img className="card-img-top" src={reqBoViewReqs}  alt="Card image cap"/>
                                        <center>
                                            <a className="btn btn-lg btn-success btn-login text-uppercase fw-bold mb-5" href="/allrequest" role="button" >Go</a>
                                        </center>
                                    </div>
                                </div>
                            </div>
